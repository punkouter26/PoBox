...
{
    public class MessagePipeDiagnosticsInfoTreeViewItem : TreeViewItem<int>
    {
    ...
    public class MessagePipeDiagnosticsInfoTreeView : TreeView<int>
    {
        ...
        MessagePipeDiagnosticsInfoTreeView(TreeViewState<int> state, MultiColumnHeader header)
            : base(state, header)
        {
            rowHeight = 20;
