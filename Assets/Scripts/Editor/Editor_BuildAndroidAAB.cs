...
namespace PoBox.Editor
{
    ...
    ///     C:/Users/punko/Downloads/PoBox-Release/pobox-upload.pass   (password, one line)
    ///
    ...
    /// the .pass file (or the POBOX_KEYSTORE_PASS environment variable, which wins if
    ...
    ///
    /// Invoked from the PoBox menu, or headlessly with -executeMethod
    /// PoBox.EditorTools.Editor_BuildAndroidAAB.Build. Either way the outcome is the
    /// "AAB BUILD RESULT:" line in the editor log.
    /// </summary>
    public static class Editor_BuildAndroidAAB
    {
        private const string OUTPUT_PATH = "Builds/Android/PoBox.aab";
        ...
        /// scenes (the SCN_TRAIN_* balance, walk and locomotion scenes) and shipping those would
